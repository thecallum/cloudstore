...
namespace DocumentService.TestsGateway
{
    ...
    public class UserGatewayTests : IDisposable
    {
        ...
        public async Task RegisterUser_WhenEmailAlreadyUsed_ThrowsException()
        {
            ...
            var mockNewUser = _fixture.Build<UserDb>().With(x => x.Email, mockExistingUser.Email).Create();
        ...
        public async Task RegisterUser_WhenEmailAlreadyUsedWithDifferentCase_ThrowsException()
        {
            ...
            var mockNewUser = _fixture.Build<UserDb>().With(x => x.Email, mockNewUserEmail).Create();
        ...
        {
            // Arrange
            var mockNewUser = _fixture.Create<UserDb>();
